...
void Game::UpdateCamera(const GameTimer& gt)
{
	...
	XMVECTOR pos = XMVectorSet(mCamPos.x, mCamPos.y, mCamPos.z, 1.0f);
	XMVECTOR target = XMVectorSet(mCamPos.x, mCamPos.y, 0.0f, 1.0f);
...
void Game::UpdateObjectCBs(const GameTimer& gt)
{
	...
	for (auto& e : mAllRitems)
	{
		...
		{
			XMMATRIX world = XMLoadFloat4x4(&e->WorldSpace);
...
void Game::BuildShapeGeometry()
{
	...
	GeometryGenerator::MeshData quad = geoGen.CreateQuad(0, 0, 1, 1, 1);
